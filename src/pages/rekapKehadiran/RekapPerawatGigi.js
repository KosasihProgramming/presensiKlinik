...
class RekapKehadiranPerawatGigi extends Component {
  ...
  handleExport = (e) => {
    ...
    this.downloadCSV(
      csvContent,
      `Data Rekap Kehadiran Perawat Gigi ${this.state.bulan} ${this.state.tahun} ${this.state.namaKlinik}.csv`
    );
    ...
    this.downloadCSV(
      csvContent2,
      `Data Rekap Kehadiran Perawat Gigi Pengganti ${this.state.bulan} ${this.state.tahun} ${this.state.namaKlinik}.csv`
    );
  };
