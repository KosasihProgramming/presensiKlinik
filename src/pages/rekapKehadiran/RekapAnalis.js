...
class RekapKehadiranAnalis extends Component {
  ...
  handleExport = (e) => {
    ...
    this.downloadCSV(
      csvContent,
      `Data Rekap Kehadiran Analis ${this.state.bulan} ${this.state.tahun}${this.state.namaKlinik}.csv`
    );
    ...
    this.downloadCSV(
      csvContent2,
      `Data Rekap Kehadiran Analis Pengganti ${this.state.bulan} ${this.state.tahun} ${this.state.namaKlinik}.csv`
    );
  };
